...
// audioCodec -> int editor->setAudioCodec (str int couples )
...
// audioMixer -> int editor->setAudioMixer (str )
...
// saveAudio -> int editor->saveAudio (str )
...
// audioReset -> void editor->resetAudioFilter (void )
...
tp_obj zzpy__pyAdm_get(tp_vm *vm)
{
  ...
  {
     return tp_number(pyGetFilm2Pal(editor));
  }
  if (!strcmp(key, "audioEncoding"))
  {
     return tp_number(pyGetAudioEncoding(editor));
  }
  if (!strcmp(key, "audioPal2film"))
  {
     return tp_number(pyGetPal2Film(editor));
  }
  if (!strcmp(key, "audioResample"))
  {
     return tp_number(editor->getAudioResample());
  }
  ...
  {
     return tp_number(pyGetNormalizeMode(editor));
  }
  if (!strcmp(key, "audioFrequency"))
  {
     return tp_number(pyGetAudioFrequency(editor));
  }
  if (!strcmp(key, "audioChannels"))
  {
     return tp_number(pyGetAudioChannels(editor));
  }
  ...
  {
     return tp_number(pyGetNormalizeValue(editor));
  }
...
tp_obj zzpy__pyAdm_set(tp_vm *vm)
{
  ...
  {
     int val = pm.asInt();
     pySetFilm2Pal(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "audioEncoding"))
  {
     int val = pm.asInt();
     pySetAudioEncoding(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "audioPal2film"))
  {
     int val = pm.asInt();
     pySetPal2Film(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "audioResample"))
  {
     int val = pm.asInt();
     editor->setAudioResample(val);
     return tp_None;
  }
  if (!strcmp(key, "markerA"))
  {
  ...
  {
     int val = pm.asInt();
     pySetNormalizeMode(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "audioFrequency"))
  {
     int val = pm.asInt();
     pySetAudioFrequency(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "audioChannels"))
  {
     int val = pm.asInt();
     pySetAudioChannels(editor, val);
     return tp_None;
  }
  if (!strcmp(key, "markerB"))
  {
  ...
  {
     int val = pm.asInt();
     pySetNormalizeValue(editor, val);
     return tp_None;
  }
  return tp_None;
}
...
static tp_obj zzpy__pyAdm_help(TP)
{
	...
	engine->callEventHandlers(IScriptEngine::EVENT_TYPE_INFORMATION, NULL, -1, "audioCodec(str,int,couples)");
	...
	engine->callEventHandlers(IScriptEngine::EVENT_TYPE_INFORMATION, NULL, -1, "audioMixer(str)");
	engine->callEventHandlers(IScriptEngine::EVENT_TYPE_INFORMATION, NULL, -1, "getFps1000(IEditor)");
	engine->callEventHandlers(IScriptEngine::EVENT_TYPE_INFORMATION, NULL, -1, "saveAudio(str)");
	...
	engine->callEventHandlers(IScriptEngine::EVENT_TYPE_INFORMATION, NULL, -1, "audioReset(void)");
