...
{ FEATURES_HIDE_AUDIOMETRE,"features.hide_audioMetre"                 ,ADM_param_bool    	,"0",	0,	1},
{ FEATURES_HIDE_CODECOPTIONS,"features.hide_codecOptions"             ,ADM_param_bool    	,"0",	0,	1},
{ FEATURES_HIDE_NAVIGATION,"features.hide_navigation"                 ,ADM_param_bool    	,"0",	0,	1},
{ FEATURES_HIDE_SELECTION,"features.hide_selection"                   ,ADM_param_bool    	,"0",	0,	1},
{ FEATURES_HIDE_VOLUME,"features.hide_volume"                         ,ADM_param_bool    	,"0",	0,	1},
