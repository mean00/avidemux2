...
static optionDesc myOptions[] = {
    ...
    {KEYBOARD_SHORTCUTS_USE_ALTERNATE_KBD_SHORTCUTS, "keyboard_shortcuts.use_alternate_kbd_shortcuts", ADM_param_bool,
     "0", 0, 1},
    ...
    {VIDEODEVICE, "videodevice", ADM_param_uint32_t, "0", 0, 11},
    ...
    {DEFAULT_DOWNMIXING, "Default.downmixing", ADM_param_uint32_t, "1", 0, 5},
    ...
    {INDEXING_INDEXING_FLAGS, "indexing.indexing_flags", ADM_param_uint32_t, "0", 0, 4294967295},
};
