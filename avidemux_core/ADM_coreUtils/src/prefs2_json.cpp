...
json.addBool("time_fields_extra_buttons",key->features.time_fields_extra_buttons);
json.addBool("current_time_field_editable",key->features.current_time_field_editable);
json.addBool("total_time_field_editable",key->features.total_time_field_editable);
json.addBool("selection_time_field_editable",key->features.selection_time_field_editable);
json.addBool("marker_a_time_field_editable",key->features.marker_a_time_field_editable);
json.addBool("marker_b_time_field_editable",key->features.marker_b_time_field_editable);
...
json.addUint32("fps_type",key->pictures.fps_type);
json.endNode();
json.addNode("hdr");
