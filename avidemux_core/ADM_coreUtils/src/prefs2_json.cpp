...
json.addBool("hide_audioMetre",key->features.hide_audioMetre);
json.addBool("hide_codecOptions",key->features.hide_codecOptions);
json.addBool("hide_navigation",key->features.hide_navigation);
json.addBool("hide_selection",key->features.hide_selection);
json.addBool("hide_volume",key->features.hide_volume);
json.endNode();
