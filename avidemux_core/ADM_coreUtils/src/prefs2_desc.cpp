...
extern const ADM_paramList my_prefs_struct_param[]={
 ...
 {"hdr.colorspace_conversion",offsetof(my_prefs_struct,hdr.colorspace_conversion),"bool",ADM_param_bool},
 {"hdr.tonemapping",offsetof(my_prefs_struct,hdr.tonemapping),"uint32_t",ADM_param_uint32_t},
 {"hdr.pregain",offsetof(my_prefs_struct,hdr.pregain),"float",ADM_param_float},
 {"hdr.postgain",offsetof(my_prefs_struct,hdr.postgain),"float",ADM_param_float},
