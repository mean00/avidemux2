...
#define MKTAG(a,b,c) {a,c,#a}
  ...
  MKTAG(MKV_VIDEO_COLOUR,0x55B0,ADM_MKV_TYPE_CONTAINER),
  MKTAG(MKV_VIDEO_COLOUR_MATRIX_COEFF,0x55B1,ADM_MKV_TYPE_UINTEGER),
  MKTAG(MKV_VIDEO_COLOUR_RANGE,0x55B9,ADM_MKV_TYPE_UINTEGER),
  MKTAG(MKV_VIDEO_COLOUR_TRANSFER,0x55BA,ADM_MKV_TYPE_UINTEGER),
  MKTAG(MKV_VIDEO_COLOUR_PRIMARIES,0x55BB,ADM_MKV_TYPE_UINTEGER),
  MKTAG(MKV_VIDEO_COLOUR_MAX_CLL,0x55BC,ADM_MKV_TYPE_UINTEGER),
  MKTAG(MKV_VIDEO_COLOUR_MAX_FALL,0x55BD,ADM_MKV_TYPE_UINTEGER),

  MKTAG(MKV_VIDEO_COLOUR_MASTERING_META,0x55D0,ADM_MKV_TYPE_CONTAINER),
  MKTAG(MKV_VIDEO_COLOUR_RED_X,0x55D1,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_RED_Y,0x55D2,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_GREEN_X,0x55D3,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_GREEN_Y,0x55D4,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_BLUE_X,0x55D5,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_BLUE_Y,0x55D6,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_WHITE_X,0x55D7,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_WHITE_Y,0x55D8,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_MAX_LUM,0x55D9,ADM_MKV_TYPE_FLOAT),
  MKTAG(MKV_VIDEO_COLOUR_MIN_LUM,0x55DA,ADM_MKV_TYPE_FLOAT),
...
//*********** TAGS ****************
   ...
   MKTAG(MKV_LANGUAGE_IETF,0x22B59D,ADM_MKV_TYPE_STRING),
