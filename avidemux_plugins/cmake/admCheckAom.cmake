...
IF(${AOM_FOUND})
    ...
    ELSE()
        MESSAGE(STATUS "MSVC, skipping check for decoder functionality in the lib")
    ENDIF()
    IF(${AOM_DEC_INIT_FOUND} OR MSVC)
        SET(USE_AOM_DEC 1)
...
IF(${AOM_FOUND})
    ...
    ELSE()
        MESSAGE(STATUS "MSVC, skipping check for encoder functionality in the lib")
    ENDIF()
    IF(${AOM_ENC_INIT_FOUND} OR MSVC)
        SET(USE_AOM_ENC 1)
