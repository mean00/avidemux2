...
bool  artChromaKey_jserialize(const char *file, const artChromaKey *key){
admJson json;
...
json.addUint32("spill",key->spill);
json.addString("imagefile",key->imagefile);
return json.dumpToFile(file);
};
bool  artChromaKey_jdeserialize(const char *file, const ADM_paramList *tmpl,artChromaKey *key){
