...
extern "C"
{
#include "x265_encoder_desc.cpp"
}
extern bool         x265Configure(void);
extern x264_encoder x265Settings;
extern bool x265LoadProfile(const char *profile);
void resetConfigurationData()
{
	x265_encoder defaultConf = X265_DEFAULT_CONF;

	memcpy(&x265Settings, &defaultConf, sizeof(x265_encoder));
}
...
ADM_DECLARE_VIDEO_ENCODER_MAIN("x265",
                               ...
                               "x265 based HEVC Encoder (c) 2014 Mean/Gruntster",
                                ...
                                ADM_UI_TYPE_BUILD,
                                1,0,0,
                                x265_encoder_param, // conf template
