...
extern const ADM_paramList x264_encoder_param[]={
 ...
 {"vui.overscan",offsetof(x264_encoder,vui.overscan),"uint32_t",ADM_param_uint32_t},
 {"vui.vidformat",offsetof(x264_encoder,vui.vidformat),"uint32_t",ADM_param_uint32_t},
 {"vui.fullrange",offsetof(x264_encoder,vui.fullrange),"bool",ADM_param_bool},
 {"vui.colorprim",offsetof(x264_encoder,vui.colorprim),"uint32_t",ADM_param_uint32_t},
 {"vui.transfer",offsetof(x264_encoder,vui.transfer),"uint32_t",ADM_param_uint32_t},
 {"vui.colmatrix",offsetof(x264_encoder,vui.colmatrix),"uint32_t",ADM_param_uint32_t},
 {"vui.chroma_loc",offsetof(x264_encoder,vui.chroma_loc),"uint32_t",ADM_param_uint32_t},
