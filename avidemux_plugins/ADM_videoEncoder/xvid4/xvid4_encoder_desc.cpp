...
extern const ADM_paramList xvid4_encoder_param[]={
 ...
 {"qMin",offsetof(xvid4_encoder,qMin),"uint32_t",ADM_param_uint32_t},
 {"qMax",offsetof(xvid4_encoder,qMax),"uint32_t",ADM_param_uint32_t},
