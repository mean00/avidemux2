// Generated by admPyClass.pl from binding/pyDFInteger.admPyClass, DO NOT edit !
...
static tp_obj zzpy__pyDFInteger_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "obj	DFInteger(str title, int min, int max)\n");
