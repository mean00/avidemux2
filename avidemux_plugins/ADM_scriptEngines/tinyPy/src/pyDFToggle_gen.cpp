// Generated by admPyClass.pl from binding/pyDFToggle.admPyClass, DO NOT edit !
...
static tp_obj zzpy__pyDFToggle_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "obj	DFToggle(str title)\n");
