...
static tp_obj zzpy__pyAdm_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioAddExternal(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioAddTrack(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioBitrate(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioChannels(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioClearTracks()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioCodec(int,str,couples)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioEncoding(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioFrequency(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioGetResample(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "void\t audioResetFilter(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetChannelDelays(int,int,int,int,int,int,int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetChannelGains(int,double,double,double,double,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetChannelRemap(int,int,int,int,int,int,int,int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetCustomFrameRate(int,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetDrc(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetDrc2(int,int,int,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetEq(int,int,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetFilm2Pal(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetMixer(int,str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetNormalize(int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetNormalize2(int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetPal2Film(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetResample(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t audioSetShift(int,int,int)\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t clearSegments(void)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "void\t clearVideoFilters(void)\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t getPARHeight(void)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t getPARWidth(void)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "str\t getVideoCodec(void)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t getWidth()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t loadVideo(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t save(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t saveAudio(int,str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t saveBmp(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t saveJpeg(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t savePng(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t seekFrame(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t seekKeyFrame(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t setContainer(str,couples)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t setCurrentPts(double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t setHDRConfig(int,double,double,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t setPostProc(int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "int\t setSourceTrackLanguage(int,str)\n");
