...
static tp_obj zzpy__pyAdm_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetChannelGains(IEditor,int,double,double,double,double,double,double,double,double,double)\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetDrc2(IEditor,int,int,int,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetEq(IEditor,int,int,double,double,double,double,double)\n");
