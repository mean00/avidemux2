...
static tp_obj zzpy__pyAdm_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioAddExternal(str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioAddTrack(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioBitrate(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioChannels(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioClearTracks()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioCodec(int,str,couples)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioEncoding(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioFrequency(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioGetResample(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioResetFilter(int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetChannelDelays(int,int,int,int,int,int,int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetChannelGains(int,double,double,double,double,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetChannelRemap(int,int,int,int,int,int,int,int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetCustomFrameRate(int,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetDrc(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetDrc2(int,int,int,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetEq(int,int,double,double,double,double,double)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetFilm2Pal(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetMixer(int,str)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetNormalize(int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetNormalize2(int,int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetPal2Film(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetResample(int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioSetShift(int,int,int)\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioTotalTracksCount()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "audioTracksCount()\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "getFps1000()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "getHeight()\n");
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "getOutputExtension()\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "getWidth()\n");
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "setHDRConfig(int,double,double,int,int)\n");
