// Generated by admPyClass.pl from binding/pyDFTimeStamp.admPyClass, DO NOT edit !
...
static tp_obj zzpy__pyDFTimeStamp_help(TP)
{
  ...
  engine->callEventHandlers(IScriptEngine::Information, NULL, -1, "obj	DFTimeStamp(str title , int min, int max)\n");
