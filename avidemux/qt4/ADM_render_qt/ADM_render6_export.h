...
#if defined(ADM_render6_cli_EXPORTS) || defined(ADM_render6_gtk_EXPORTS) || defined(ADM_render6_QT4_EXPORTS) ||        \
    defined(ADM_render6_QT5_EXPORTS) || defined(ADM_render6_QT6_EXPORTS)
