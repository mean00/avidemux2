...
ADM_COREVIDEOFILTER6_EXPORT ADM_coreVideoFilter *ADM_vf_createFromTag(uint32_t tag, ADM_coreVideoFilter *last,
                                                                      CONFcouple *couples);
ADM_COREVIDEOFILTER6_EXPORT ADM_VideoFilterElement *ADM_vf_insertFilterFromTag(IEditor *editor, uint32_t tag,
                                                                               CONFcouple *c, int index);
ADM_COREVIDEOFILTER6_EXPORT ADM_VideoFilterElement *ADM_vf_addFilterFromTag(IEditor *editor, uint32_t tag,
                                                                            CONFcouple *c, bool configure);
