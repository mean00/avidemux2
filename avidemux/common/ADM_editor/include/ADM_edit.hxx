...
/******************************* HDR tonemaping config *******************************/
                    uint8_t             setHDRConfig( uint32_t toneMappingMethod, float saturationAdjust, float boostAdjust, bool adaptiveRGB);
                    uint8_t             getHDRConfig( uint32_t * toneMappingMethod, float * saturationAdjust, float * boostAdjust, bool * adaptiveRGB);
/******************************* /HDR tonemaping config ******************************/
/******************************* Editing ************************************/
