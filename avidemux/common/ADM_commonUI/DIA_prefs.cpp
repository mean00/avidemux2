...
#define CPU_CAPS(x) \
    if((cpuCaps & cpuMask) & ADM_CPUCAP_##x) \
        ...
        diaElemToggle openFiltersMaximized(&maximizedFilters,QT_TRANSLATE_NOOP("adm","_Open filters maximized"));
...
//--
        ...
        diaElemTabs tabUser(QT_TRANSLATE_NOOP("adm","User Interface"),8,diaUser);
