...
public:
        ...
        static IDirectXVideoDecoder *createDecoder(AVCodecID codec, int width, int height, int numSurface, LPDIRECT3DSURFACE9 *surface, int bits);
        ...
        static bool allocateDecoderSurface(void *parent, int width, int height, int num, LPDIRECT3DSURFACE9 *surfaces, std::vector<admDx2Surface *>&listOf, int bits=8);
};
