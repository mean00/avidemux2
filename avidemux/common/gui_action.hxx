...
#define ADM_MAX_SCRIPT_ENGINES 5*3
enum Action
{
    ACT_INVALID = 0,
...
ACT_AUTO_BASE_PY,
ACT_AUTO_END_PY=ACT_AUTO_BASE_PY+ADM_MAX_CUSTOM_SCRIPT,
ACT_SCRIPT_ENGINE_FIRST,
ACT_SCRIPT_ENGINE_LAST = ACT_SCRIPT_ENGINE_FIRST + ADM_MAX_SCRIPT_ENGINES,
ACT_DUMMY
};
