...
# Qt
    ${File} ${BINARY_FOLDER}/Qt6Core.dll
    ${File} ${BINARY_FOLDER}/Qt6Gui.dll
    ${File} ${BINARY_FOLDER}/Qt6Network.dll
    ${File} ${BINARY_FOLDER}/Qt6OpenGL.dll
    ${File} ${BINARY_FOLDER}/Qt6OpenGLWidgets.dll
    ${File} ${BINARY_FOLDER}/Qt6Widgets.dll
    SetOutPath $INSTDIR\styles
    ${File} ${BINARY_FOLDER}/styles/qmodernwindowsstyle.dll
    SetOutPath $INSTDIR
