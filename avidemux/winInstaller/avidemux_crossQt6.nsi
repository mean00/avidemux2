...
installQt${LANG_CODE}:
    SetOutPath $INSTDIR\qt6\i18n
    ${File} qt6/i18n/avidemux_${LANG_CODE}.qm
    ${File} qt6/i18n/qtbase_${LANG_CODE}.qm
endQt${LANG_CODE}:
!macroend
#
...
!macroend
!macro InstallDevQt6 xname
         SetOutPath $INSTDIR\include\avidemux\${API_VERSION}\qt6\${xname}
         ${File} ${DEV_FOLDER}/include/avidemux/${API_VERSION}/qt6/${xname}/*
!macroend
...
Section  "User interfaces" SecGrpUI
        ...
        SetOutPath $INSTDIR\qt6\i18n
        ${File} ${BINARY_FOLDER}/qt6/i18n/*.qm
SectionEnd
# !!
Section "Plugins" SecGrpPlugins
        ...
        #
        SetOutPath $INSTDIR\plugins\videoEncoders\qt6
        ${File} ${BINARY_FOLDER}/plugins/videoEncoders/qt6/*.dll
        ...
        SetOutPath $INSTDIR\plugins\videoFilters\qt6
        ${File} ${BINARY_FOLDER}/plugins/videoFilters/qt6/*.dll
...
!if ${GOT_AVISYNTH}
    Section "Avisynth_VapourSynth" SecGrpAvisynth
        ...
        # TMP ${File} ${BINARY_FOLDER}/vsProxy_gui_qt6.exe
   SectionEnd
!endif
#
...
Section "SDK (to write plugins)" SecGrpDev
        ...
        !insertmacro InstallDev libpostproc
        !insertmacro InstallDev qt6
        !insertmacro InstallDevQt6 ADM_openGL
        !insertmacro InstallDevQt6 ADM_UIs
