...
!define PRODUCT_NAME "Avidemux ${CORE_VERSION} - 32 bits"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Avidemux (32bits)"
...
${MementoSection} "-Start menu Qt" SecStartMenuQt
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Avidemux job control (32 Bits).lnk" $INSTDIR\avidemux_jobs.exe
    !insertmacro MUI_STARTMENU_WRITE_END
${MementoSectionEnd}
...
Section Uninstall
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Avidemux job control (32 Bits).lnk"
