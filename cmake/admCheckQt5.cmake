...
#        SET(QT5_CHECKED 1)
    IF (NOT QT5_CHECKED)
        ...
        IF(CROSS)
                ...
                SET(QT_HEADERS_DIR   ${QT_HOME}/include/qt5  ${QT_HOME}/include/qt5/QtGui ${QT_HOME}/include/qt5/QtCore ${QT_HOME}/include/qt5/QtWidgets ${QT_HOME}/include/qt5/Network)
                ...
                SET(QT_QTCORE_NETWORK Qt5Network)
