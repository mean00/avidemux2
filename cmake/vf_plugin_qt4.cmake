...
MACRO(INIT_VIDEO_FILTER_QT4  lib  _srcsQt _headersQt _srcQt_ui  )
  IF(DO_QT4)
    ...
    TARGET_LINK_LIBRARIES( ${lib} ${lib} PRIVATE ADM_UI${QT_LIBRARY_EXTENSION}6  ADM_render6)
    TARGET_LINK_LIBRARIES(${lib} ${lib} PRIVATE ${QT_QTGUI_LIBRARY} ${QT_QTCORE_LIBRARY})
