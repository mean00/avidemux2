...
localPath = ['/opt/local','/usr/local/opt','/usr/local/Cellar/','/usr/local/lib']
#
# /usr/local/Cellar/qt/4.8.7_1/lib/QtCore.framework/Versions/4/QtCore
#
allSymbols=[]
#
#
...
def copyQtDeps(components,libFolder):
    ...
    for modul in components:
        absPath='/usr/local/opt/qt/lib/'+modul+'.framework/Versions/4/'+modul
...
def copyQtFiles(targetFolder):
        ...
        for q in qts:
               ...
               if(os.path.exists(targetFolder+'/'+q+'.framework')):
                   ...
                   src='/usr/local/opt/qt/lib/'+q+'.framework'
	...
	myCopyTree('/usr/local/opt/qt/plugins/imageformats',qtPluginFolder+'/imageformats')
	myCopyTree('/usr/local/opt/qt/plugins/platforms',qtPluginFolder+'/platforms')
#################################################################
