...
if (NOT EXISTS  "${FFMPEG_SOURCE_DIR}/${FFMPEG_VERSION}")
	...
	MESSAGE(STATUS "${TAR_EXECUTABLE}  --exclude .git czf ${LIBRARY_SOURCE_DIR}/${FFMPEG_SOURCE_ARCHIVE} ffmpeg, DIR=${FFMPEG_BASE_DIR}")
	execute_process(COMMAND ${TAR_EXECUTABLE} czf  "${LIBRARY_SOURCE_DIR}/${FFMPEG_SOURCE_ARCHIVE}" --exclude .git source
