        ...
        IF (NOT X264_CHECKED)
                ...
                IF (X264)
                        ...
                        IF (_X264_FOUND)
                                ...
                                IF (x264_version LESS 153)
                                        MESSAGE("WARNING: x264 core version is too old.  At least version 153 is required.")
                                        SET(X264_FOUND 0)
                                ELSE (x264_version LESS 153)
                                        FIND_HEADER_AND_LIB(X264 x264.h x264 x264_encoder_open_${x264_version})
                                ENDIF (x264_version LESS 153)
                                IF (X264_FOUND)
