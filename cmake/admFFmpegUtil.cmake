...
MACRO (getFfmpegLibNames sourceDir)
	...
	elseif (MSVC)
                set(LIBAVCODEC_LIB   libavcodec.dll.a)
                set(LIBAVFORMAT_LIB  libavformat.dll.a)
                set(LIBAVUTIL_LIB    libavutil.dll.a)
                set(LIBPOSTPROC_LIB  libpostproc.dll.a)
                set(LIBSWSCALE_LIB   libswscale.dll.a)
	endif (APPLE)
