...
MACRO(INIT_VIDEO_FILTER_GLQT4  lib  _srcsQt _headersQt _srcQt_ui  )
		...
		TARGET_LINK_LIBRARIES( ${lib} ADM_UI${QT_LIBRARY_EXTENSION}6  ADM_render6_${QT_LIBRARY_EXTENSION} ADM_openGL${QT_LIBRARY_EXTENSION}6)
		TARGET_LINK_LIBRARIES(${lib} ${QT_QTGUI_LIBRARY} ${QT_QTCORE_LIBRARY})
		TARGET_LINK_LIBRARIES(${lib} ${OPENGL_LIBRARIES} ${QT_QTOPENGL_LIBRARIES})
